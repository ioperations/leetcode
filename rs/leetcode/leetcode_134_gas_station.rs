...
// once in the clockwise direction, otherwise return -1. If there exists a
...
mod tests {
    ...
    fn case1_test() {
        ...
        // tank = 0 + 4 = 4 Travel to station 4. Your tank = 4 - 1 + 5 =
        // 8 Travel to station 0. Your tank = 8 - 2 + 1 = 7
