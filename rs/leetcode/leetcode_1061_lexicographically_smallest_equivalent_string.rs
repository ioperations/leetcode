...
// 'd', and 'c' == 'e'. Equivalent characters follow the usual rules of any
// equivalence relation: Reflexivity: 'a' == 'a'.
// Symmetry: 'a' == 'b' implies 'b' == 'a'.
// Transitivity: 'a' == 'b' and 'b' == 'c' implies 'a' == 'c'.
// For example, given the equivalency information from s1 = "abc" and s2 =
// "cde", "acd" and "aab" are equivalent strings of baseStr = "eed",
...
impl Solution {
    #[allow(unused)]
    pub fn smallest_equivalent_string(
        s1: &str,
        s2: &str,
        base_str: &str,
    ) -> String {
...
mod tests {
    ...
    fn case1_test() {
        ...
        // can group their characters as [m,p], [a,o], [k,r,s], [e,i].
    ...
    fn case2_test() {
        ...
        // characters as [h,w], [d,e,o], [l,r]. So only the second
        // letter 'o' in baseStr is changed to 'd', the answer is "hdld".
        let ret = Solution::smallest_equivalent_string(s1, s2, base_str);
        assert_eq!(ret, output);
    }
    ...
    fn case3_test() {
        ...
        // We group the equivalent characters in s1 and s2 as [a,o,e,r,s,c],
        // [l,p], [g,t] and [d,m], thus all letters in baseStr except
