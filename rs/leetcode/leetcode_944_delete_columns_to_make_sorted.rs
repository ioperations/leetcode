...
// In the above example (0-indexed), columns 0 ('a', 'b', 'c') and 2 ('c', 'e',
// 'e') are sorted while column 1 ('b', 'c', 'a') is not, so you would delete
// column 1. Return the number of columns that you will delete.
...
impl Solution {
    ...
    pub fn min_deletion_size(strs: Vec<String>) -> i32 {
        ...
        let strs: Vec<Vec<char>> =
            { strs.into_iter().map(|ele| ele.chars().collect()).collect() };
        let n = strs.len();
