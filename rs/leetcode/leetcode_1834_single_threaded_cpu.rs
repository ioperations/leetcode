...
// ith task will be available to process at enqueueTimei and will take
// processingTimei to finish processing. You have a single-threaded CPU that can
// process at most one task at a time and will act in the following way:
...
impl Solution {
    ...
    pub fn get_order(tasks: Vec<Vec<i32>>) -> Vec<i32> {
        ...
        while !tasks.is_empty() || !pq.is_empty() {
            if pq.is_empty() {
                // if pq is empty, find smallest num in the tasks, push them
                // into pq
...
mod tests {
    ...
    fn case1_test() {
        ...
        // - Also at time = 1, the idle CPU starts processing task 0. Available
        //   tasks = {}.
        // - At time = 2, task 1 is available to process. Available tasks = {1}.
        // - At time = 3, task 2 is available to process. Available tasks = {1,
        //   2}.
        // - Also at time = 3, the CPU finishes task 0 and starts processing
        //   task 2 as it is the shortest. Available tasks = {1}.
        // - At time = 4, task 3 is available to process. Available tasks = {1,
        //   3}.
    ...
    fn case2_test() {
        ...
        //   {0,1,2,3,4}.
        // - Also at time = 7, the idle CPU starts processing task 4. Available
        //   tasks = {0,1,2,3}.
